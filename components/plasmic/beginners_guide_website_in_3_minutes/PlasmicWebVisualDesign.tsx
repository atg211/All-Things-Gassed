...
import sty from "./PlasmicWebVisualDesign.module.css"; // plasmic-import: isPld9o9elpU/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__mgOfb)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img___1Oarw)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__v0RdE)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__mzzNy)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ewqj2)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__wVd4T)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___48PzR)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__e8RpG)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___1CE4)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns___2EzXq)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__tpnvY)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___4Ouks)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__xfApY)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___7Wg4C)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox___7Han)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___3IyEe)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__yJu6L)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___8WotX)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox___9E7In)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__qCuYi)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__xrAkt)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__zFbP)}
              >
                <div className={classNames(projectcss.all, sty.column___4AtI)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__qRa0J
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column___8SBau)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__dic3E
                    )}
