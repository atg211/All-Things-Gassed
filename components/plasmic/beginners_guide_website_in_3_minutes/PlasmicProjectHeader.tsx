...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: UDjiH2SkqjxO/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__e7DRl)}>
        <div className={classNames(projectcss.all, sty.column__lx9ZQ)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__tXXqR)}>
          <div className={classNames(projectcss.all, sty.columns___8AheY)}>
            <div className={classNames(projectcss.all, sty.column__ih7Sb)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__qr2D)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__cuI5H)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___5B7Rf)}>
                {renderPlasmicSlot({
