...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: 9Y5te3P4f3hz/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__aXnwg)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__nqYv)}>
          <PlasmicLink__
